+++
title = "Track 03 — Seven Wives"
linkTitle = "Seven Wives"
description = "\"What a thing it is for a man to be accused of having seven wives, when I can only find one.\" He stood at the pulpit and lied."
summary = "\"What a thing it is for a man to be accused of having seven wives, when I can only find one.\" He stood at the pulpit and lied."
weight = 3
...
1. **Sardonic tone** - This isn't angry like "Forbearance." It's bitter, almost mocking. The audacity of the lie.
2. **His words as the hook** - "Seven wives when I can only find one" repeats because it's so brazen
3. **The bridge names real people** - Jane Law, Austin Cowles, William Law. These were sworn witnesses.
4. **Sparse arrangement** - Let the words land. The lie speaks for itself.
5. **Whispered outro** - "I can prove them all perjurers" echoes as bitter irony. He couldn't. They could.
...
1. That's what the Expositor documented
2. We're telling the Expositor's story, not the full historical picture
3. It shows how deep the secrecy was - even insiders only knew about ten
4. "Ten" is still devastating when contrasted with "I can only find one"
